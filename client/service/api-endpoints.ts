...
export const Document_Design_List = "FormDesignCompiler/DocumentDesignList?tenantId=1&_search=false&nd=1756980878041&rows=10000&page=1&sidx=DocumentDesignName&sord=asc&filters={"groupOp":"AND","rules":[]}";