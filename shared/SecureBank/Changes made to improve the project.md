...
| 8 | GEO_IMPOSSIBLE fraud rule (city + last-location state store) + window grace period | ✅ Done — see `Changes made in this session (2026-07-06).md` | — |
| 9 | Closed fraud loop: account-service consumes `alerts` → freezes account → blocks withdrawals | ✅ Done — see `Changes made in this session (2026-07-06).md` | — |
