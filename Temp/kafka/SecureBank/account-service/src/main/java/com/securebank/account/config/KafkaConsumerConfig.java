...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, TransactionEvent> consumerFactory() {
        ...
        // Wrap deserializers with ErrorHandlingDeserializer → poison messages routed to DLT handler
        ...
        // Manual offset commit only after successful DB write → at-least-once with idempotency
